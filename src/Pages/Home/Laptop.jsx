...
import { FaRegEye, FaShoppingCart, FaStar,FaLongArrowAltRight } from "react-icons/fa";
import { Link } from "react-router-dom";
import useProducts from "../../hooks/useProducts";
import { useCartContext } from "../../hooks/useCartContext";
const Laptop = () => {
  const [products] = useProducts();
  const laptopData = products.filter(product => product?.category === 'Laptops')
  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto px-3 md:px-0 py-10">
        ...
        <h5 className="text-2xl font-semibold">Latest Laptop</h5>
        ...
        >
            {laptopData.map(product => (
                ...
                <div className="flex flex-col rounded relative group shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
