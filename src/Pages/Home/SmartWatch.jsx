...
const SmartWatch = () => {
  ...
  const watchData = products.filter(product => product?.category === 'Smartwatches')
  const {addToCart} = useCartContext();

  return (
    <div>
      <div className="max-w-screen-xl mx-auto px-3 md:px-0 py-10">
        <div className="flex justify-between py-5 uppercase px-5">
        <h5 className="text-2xl font-semibold">Smart Watchs</h5>
