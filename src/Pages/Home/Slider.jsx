...
const Slider = () => {
  ...
  return (
    <div className="bg-[#EDF1F3] py-10 px-3 md:px-0">
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="md:flex items-center justify-between gap-10">
            ...
            <div className="md:w-2/3 text-center md:text-start">
              ...
              <button className="bg-black text-white px-5 py-2 mt-5 border border-black hover:text-black hover:bg-transparent transition-all duration-150 delay-150">Shop Product</button>
            </div>
            {/* Image container */}
